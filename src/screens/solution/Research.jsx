    ...
    <>
      <div className="about__contect__section">
        ...
        <div className="about__contect__section__sub__heading">
          ...
          research drives our understanding of the cause and effect of disease,
          helps develop and test interventions and measures outcomes. Biomedical
          research, particularly human subjects research, is an increasingly
          complex and highly regulated field. Protecting human volunteers is
          paramount, balancing it with the need to generate new knowledge. The
          success of an institution, organization or indeed a country can be
          measured by the amount of new knowledge generated through original
          research. However, research is not recognized by leading authorities,
          and may even jeopardize individuals and institutions if proper
          regulatory procedures are not diligently followed.
          <br />
          <br />
      ...
      <div className="about__contect__section">
        <div className="about__contect__section__sub__heading">
          ...
          methodology, cohort development, creating large national datasets, and
          conducting clinical trials. We can also help develop and train the
          regulatory workforce, e.g. Institutional Review Boards, Data Safety
