  ...
  return (
    <>
      <div className="solution__container">
        ...
        <Link to="/solution/traning" className="solution__text__wraper__entry">
        ...
        <Link to="/solution/reducing" className="solution__text__wraper__entry">
          Reducing Variance in Care Delivery
        </Link>
        <Link to="/solution/clinical" className="solution__text__wraper__entry">
          Upgrading Post Graduate Training Programs
        </Link>
        <Link to="/solution/research" className="solution__text__wraper__entry">
