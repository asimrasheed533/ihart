      ...
      <div className="solution__container">
        <div className="solution__text__wraper">
          ...
          <div className="solution__text__wraper__sub__heading">
            Health systems around the world have varying approaches to managing
            similar healthcare conditions. However, evidence shows that when
            care models differ, clinical outcomes are not optimal and patient
            safety can be compromised. In response, healthcare organizations are
            employing standardization of pathways, policies and protocols as
            proven tools for increasing uniformity of practice and patient
            safety, and reducing the number of errors.
            <br />
            <br />
            ...
            first wave, 5 pathways will be identified, with an option to add as
            many clinical pathways as needed or desired by the organization.
          </div>
        </div>
      </div>
