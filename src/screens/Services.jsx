  ...
  return (
    <>
      ...
      <section className="scop__wraper__main" id="scope">
        ...
        <Fade bottom>
          <div className="scop__wraper__main__entry">
            <span>Education and Training support:</span> comprehensive support
            for educational meetings, conferences, symposia, workshops,
            including needs assessment, program development, speaker engagement,
            CME/CPD applications, post-program evaluations and reports and
            logistics safety
          </div>
        </Fade>
        <Fade bottom>
        ...
        <Fade bottom>
          <div className="scop__wraper__main__entry">
            <span>Regulatory and Accreditation support:</span> providing
            technical evaluations, training and tracers in support of national
            and international accreditations, e.g. Joint Commission
            International, Accreditation Council for Graduate Medical Education
            International, and other similar organizations
          </div>
        </Fade>
        <Fade bottom>
          <div
            className="scop__wraper__main__entry"
            style={{ fontSize: "18px" }}
          >
